...
@protocol CKCalendarViewSwipeDelegate <NSObject>
...
@interface CKCalendarView : UIView<UIGestureRecognizerDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UICollectionViewDelegate>

@property (nonatomic, weak) id<CKCalendarViewSwipeDelegate> swipeDelegate;
